...
namespace BiiSoft.CompanySettings.Dto
{
    public class CompanySettingMapProfile : Profile
    {
        public CompanySettingMapProfile()
        {
            ...
            CreateMap<CreateUpdateCompanyAccountSettingInputDto, CompanyAccountSetting>().ReverseMap();
            CreateMap<CompanyAccountSettingDto, CompanyAccountSetting>().ReverseMap();
        }
    }
}
