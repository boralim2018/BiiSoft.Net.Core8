        ...
        public async Task<ExportFileOutput> ExportExcelTemplateAsync()
        {
            var fileInput = new ExportFileInput
            {
                ...
                Columns = new List<ColumnOutput> {
                    ...
                    new ColumnOutput{ ColumnTitle = L("ItemType"), Width = 150, IsRequired = true},
                    new ColumnOutput{ ColumnTitle = L("ItemCategory"), Width = 150, IsRequired = true },
                    ...
                    new ColumnOutput{ ColumnTitle = L("Unit"), Width = 150 },
