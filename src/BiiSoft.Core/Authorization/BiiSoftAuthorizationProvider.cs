...
namespace BiiSoft.Authorization
{
    public class BiiSoftAuthorizationProvider : AuthorizationProvider
    {
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            findPage.CreateChildPermission(PermissionNames.Pages_Find_ItemGrades, L("FindItemGrades"));
            ...
            var locationListPage = locationPage.CreateChildPermission(PermissionNames.Pages_Setup_Locations_List, L("LocationList"), featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Loctions), multiTenancySides: MultiTenancySides.Tenant);
            ...
            locationListPage.CreateChildPermission(PermissionNames.Pages_Setup_Locations_View, L("View"), featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Loctions), multiTenancySides: MultiTenancySides.Tenant);
            ...
            locationListPage.CreateChildPermission(PermissionNames.Pages_Setup_Locations_ExportExcel, L("ExportExcel"), featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Loctions), multiTenancySides: MultiTenancySides.Tenant);
            ...
            itemGroupPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_ItemGroups_SetAsDefault, L("SetAsDefault"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Groups));
            ...
            itemListPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_List_ChangeSetting, L("ChangeSetting"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items));
            ...
            unitPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Units_SetAsDefault, L("SetAsDefault"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Units));

            var modelPage = itemPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Models, L("Models"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Models));
            modelPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Models_Create, L("Create"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Models));
            modelPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Models_View, L("View"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Models));
            modelPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Models_Edit, L("Edit"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Models));
            modelPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Models_Delete, L("Delete"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Models));
            modelPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Models_ExportExcel, L("ExportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Models));
            modelPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Models_ImportExcel, L("ImportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Models));
            modelPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Models_Enable, L("Enable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Models));
            modelPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Models_Disable, L("Disable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Models));
            modelPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Models_SetAsDefault, L("SetAsDefault"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Models));
            ...
            gradePage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Grades_SetAsDefault, L("SetAsDefault"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Grades));
            ...
            sizePage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Sizes_SetAsDefault, L("SetAsDefault"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Sizes));
            ...
            colorPatternPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_ColorPatterns_SetAsDefault, L("SetAsDefault"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_ColorPatterns));
            ...
            brandPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Brands_SetAsDefault, L("SetAsDefault"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Brands));
            
            var seriesPage = itemPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Series, L("Series"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Series));
            seriesPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Series_Create, L("Create"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Series));
            seriesPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Series_View, L("View"),multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Series));
            seriesPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Series_Edit, L("Edit"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Series));
            seriesPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Series_Delete, L("Delete"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Series));
            seriesPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Series_ExportExcel, L("ExportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Series));
            seriesPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Series_ImportExcel, L("ImportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Series));
            seriesPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Series_Enable, L("Enable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Series));
            seriesPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Series_Disable, L("Disable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Series));
            seriesPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Series_SetAsDefault, L("SetAsDefault"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Series));

            var cpuPage = itemPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_CPUs, L("CPUs"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_CPUs));
            cpuPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_CPUs_Create, L("Create"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_CPUs));
            cpuPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_CPUs_View, L("View"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_CPUs));
            cpuPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_CPUs_Edit, L("Edit"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_CPUs));
            cpuPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_CPUs_Delete, L("Delete"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_CPUs));
            cpuPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_CPUs_ExportExcel, L("ExportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_CPUs));
            cpuPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_CPUs_ImportExcel, L("ImportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_CPUs));
            cpuPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_CPUs_Enable, L("Enable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_CPUs));
            cpuPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_CPUs_Disable, L("Disable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_CPUs));
            cpuPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_CPUs_SetAsDefault, L("SetAsDefault"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_CPUs));

            var ramPage = itemPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_RAMs, L("RAMs"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_RAMs));
            ramPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_RAMs_Create, L("Create"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_RAMs));
            ramPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_RAMs_View, L("View"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_RAMs));
            ramPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_RAMs_Edit, L("Edit"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_RAMs));
            ramPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_RAMs_Delete, L("Delete"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_RAMs));
            ramPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_RAMs_ExportExcel, L("ExportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_RAMs));
            ramPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_RAMs_ImportExcel, L("ImportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_RAMs));
            ramPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_RAMs_Enable, L("Enable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_RAMs));
            ramPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_RAMs_Disable, L("Disable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_RAMs));
            ramPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_RAMs_SetAsDefault, L("SetAsDefault"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_RAMs));

            var vgaPage = itemPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_VGAs, L("VGAs"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_VGAs));
            vgaPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_VGAs_Create, L("Create"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_VGAs));
            vgaPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_VGAs_View, L("View"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_VGAs));
            vgaPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_VGAs_Edit, L("Edit"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_VGAs));
            vgaPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_VGAs_Delete, L("Delete"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_VGAs));
            vgaPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_VGAs_ExportExcel, L("ExportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_VGAs));
            vgaPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_VGAs_ImportExcel, L("ImportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_VGAs));
            vgaPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_VGAs_Enable, L("Enable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_VGAs));
            vgaPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_VGAs_Disable, L("Disable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_VGAs));
            vgaPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_VGAs_SetAsDefault, L("SetAsDefault"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_VGAs));

            var hddPage = itemPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_HDDs, L("HDDs"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_HDDs));
            hddPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_HDDs_Create, L("Create"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_HDDs));
            hddPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_HDDs_View, L("View"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_HDDs));
            hddPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_HDDs_Edit, L("Edit"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_HDDs));
            hddPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_HDDs_Delete, L("Delete"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_HDDs));
            hddPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_HDDs_ExportExcel, L("ExportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_HDDs));
            hddPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_HDDs_ImportExcel, L("ImportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_HDDs));
            hddPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_HDDs_Enable, L("Enable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_HDDs));
            hddPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_HDDs_Disable, L("Disable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_HDDs));
            hddPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_HDDs_SetAsDefault, L("SetAsDefault"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_HDDs));

            var screenPage = itemPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Screens, L("Screens"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Screens));
            screenPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Screens_Create, L("Create"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Screens));
            screenPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Screens_View, L("View"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Screens));
            screenPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Screens_Edit, L("Edit"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Screens));
            screenPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Screens_Delete, L("Delete"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Screens));
            screenPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Screens_ExportExcel, L("ExportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Screens));
            screenPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Screens_ImportExcel, L("ImportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Screens));
            screenPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Screens_Enable, L("Enable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Screens));
            screenPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Screens_Disable, L("Disable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Screens));
            screenPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Screens_SetAsDefault, L("SetAsDefault"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Screens));

            var cameraPage = itemPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Cameras, L("Cameras"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Cameras));
            cameraPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Cameras_Create, L("Create"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Cameras));
            cameraPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Cameras_View, L("View"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Cameras));
            cameraPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Cameras_Edit, L("Edit"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Cameras));
            cameraPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Cameras_Delete, L("Delete"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Cameras));
            cameraPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Cameras_ExportExcel, L("ExportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Cameras));
            cameraPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Cameras_ImportExcel, L("ImportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Cameras));
            cameraPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Cameras_Enable, L("Enable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Cameras));
            cameraPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Cameras_Disable, L("Disable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Cameras));
            cameraPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Cameras_SetAsDefault, L("SetAsDefault"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Cameras));

            var batteryPage = itemPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Batteries, L("Batteries"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Batteries));
            batteryPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Batteries_Create, L("Create"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Batteries));
            batteryPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Batteries_View, L("View"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Batteries));
            batteryPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Batteries_Edit, L("Edit"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Batteries));
            batteryPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Batteries_Delete, L("Delete"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Batteries));
            batteryPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Batteries_ExportExcel, L("ExportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Batteries));
            batteryPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Batteries_ImportExcel, L("ImportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Batteries));
            batteryPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Batteries_Enable, L("Enable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Batteries));
            batteryPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Batteries_Disable, L("Disable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Batteries));
            batteryPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_Batteries_SetAsDefault, L("SetAsDefault"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_Batteries));
            ...
            fieldAPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_FieldAs_SetAsDefault, L("SetAsDefault"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_FieldAs));
            ...
            fieldBPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_FieldBs_SetAsDefault, L("SetAsDefault"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_FieldBs));
            ...
            priceLevelPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_PriceList_Edit, L("Edit"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_PriceList));
            priceLevelPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_PriceList_Delete, L("Delete"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_PriceList));
            priceLevelPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_PriceList_ExportExcel, L("ExportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_PriceList));
            priceLevelPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_PriceList_ImportExcel, L("ImportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_PriceList));
            priceLevelPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_PriceList_Enable, L("Enable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_PriceList));
            priceLevelPage.CreateChildPermission(PermissionNames.Pages_Setup_Items_PriceList_Disable, L("Disable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Items_PriceList));
            ...
            var warehouseListPage = warehousePage.CreateChildPermission(PermissionNames.Pages_Setup_Warehouses_List, L("WarehouseList"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Warehouses));
            warehouseListPage.CreateChildPermission(PermissionNames.Pages_Setup_Warehouses_Create, L("Create"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Warehouses));
            warehouseListPage.CreateChildPermission(PermissionNames.Pages_Setup_Warehouses_View, L("View"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Warehouses));
            warehouseListPage.CreateChildPermission(PermissionNames.Pages_Setup_Warehouses_Edit, L("Edit"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Warehouses));
            warehouseListPage.CreateChildPermission(PermissionNames.Pages_Setup_Warehouses_Delete, L("Delete"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Warehouses));
            warehouseListPage.CreateChildPermission(PermissionNames.Pages_Setup_Warehouses_ExportExcel, L("ExportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Warehouses));
            warehouseListPage.CreateChildPermission(PermissionNames.Pages_Setup_Warehouses_ImportExcel, L("ImportExcel"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Warehouses));
            warehouseListPage.CreateChildPermission(PermissionNames.Pages_Setup_Warehouses_Enable, L("Enable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Warehouses));
            warehouseListPage.CreateChildPermission(PermissionNames.Pages_Setup_Warehouses_Disable, L("Disable"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Warehouses));
            warehouseListPage.CreateChildPermission(PermissionNames.Pages_Setup_Warehouses_SetAsDefault, L("SetAsDefault"), multiTenancySides: MultiTenancySides.Tenant, featureDependency: new SimpleFeatureDependency(AppFeatures.Setup_Warehouses));
