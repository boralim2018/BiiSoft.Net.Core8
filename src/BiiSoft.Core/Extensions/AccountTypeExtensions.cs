...
namespace BiiSoft.Extensions
{
    ...
    {
        public static bool IsCurrentAsset(this AccountType type) => 
            type == AccountType.Cash ||
            type == AccountType.Bank ||
            type == AccountType.AccountReceivable ||
            type == AccountType.Inventory ||
            type == AccountType.CurrentAsset;

        public static bool IsNoneCurrentAsset(this AccountType type) => 
            type == AccountType.NoneCurrentAsset || 
            type == AccountType.FixedAsset;

        public static bool IsCurrentLiability(this AccountType type) => 
            type == AccountType.AccountPayable || 
            type == AccountType.CreditCard || 
            type == AccountType.CurrentLiability;

        public static bool IsCashEquivalent(this AccountType type) => 
            type == AccountType.Cash || 
            type == AccountType.Bank;
        public static bool IsRevenue(this AccountType type) => 
            type == AccountType.Revenue || 
            type == AccountType.OtherRevenue;
        public static bool IsExpense(this AccountType type) => 
            type == AccountType.Expense || 
            type == AccountType.OtherExpense;
        public static bool IsExpenseOrCostOfSale(this AccountType type) => 
            type == AccountType.Expense || 
            type == AccountType.OtherExpense || 
            type == AccountType.CostOfSale;

        public static bool IsAccumulatedDepreciation(this SubAccountType type) =>
            type == SubAccountType.AccumulatedDepletion ||
            type == SubAccountType.AccumulatedDepreciation ||
            type == SubAccountType.AccumulatedAmotization;
        ...
        public static List<SubAccountType> SubTypes(this AccountType type)
        {
            ...
            return Enum.GetValues(typeof(SubAccountType))
                       .Cast<SubAccountType>()
                       .Where(s => (int)s / 100 == typeValue)
                       .ToList();
        }

        public static string ToIntStr(this SubAccountType type)
        {
        ...
        private static readonly Dictionary<AccountType, SubAccountType> DefaultSubTypeDic = new Dictionary<AccountType, SubAccountType>
        {
            ...
            { AccountType.AccountReceivable, SubAccountType.AccountReceivable },
            { AccountType.Inventory, SubAccountType.Inventory },
            { AccountType.CurrentAsset, SubAccountType.OtherCurrentAsset },
            { AccountType.FixedAsset, SubAccountType.OtherFixedAsset },
            { AccountType.NoneCurrentAsset, SubAccountType.OtherNoneCurrentAsset },
            { AccountType.AccountPayable, SubAccountType.AccountPayable },
            { AccountType.CreditCard, SubAccountType.CreditCard },
            { AccountType.CurrentLiability, SubAccountType.OtherCurrentLiability },
            { AccountType.NoneCurrentLiability, SubAccountType.OtherNoneCurrentLiability },
            { AccountType.Equity, SubAccountType.OwnersEquity },
            { AccountType.Revenue, SubAccountType.GeneralRevenue },
            { AccountType.OtherRevenue, SubAccountType.OtherOperatingIncome },
            { AccountType.CostOfSale, SubAccountType.OtherCostOfSale },
            { AccountType.Expense, SubAccountType.AdministrativeExpense },
            { AccountType.OtherExpense, SubAccountType.OtherExpense }
        };
