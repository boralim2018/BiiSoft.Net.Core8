...
namespace BiiSoft.Migrations
{
    ...
    [Migration("20250502083149_AddBOM")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BiiSoft.BFiles.BFile", b =>
                {
                    ...
                    b.HasIndex("DisplayName", "TenantId");

                    b.HasIndex("FilePath", "TenantId")
                        .IsUnique();
            ...
            modelBuilder.Entity("BiiSoft.BOMs.BOM", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "Name", "ItemId")
                        .IsUnique();

                    b.ToTable("BiiBOMs");
                });

            modelBuilder.Entity("BiiSoft.BOMs.BOMItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("BiiSoft.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("BiiSoft.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("BiiSoft.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("BiiSoft.Authorization.Users.User", "DeleterUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BiiSoft.Branches.BranchUser", b =>
                {
                    ...
                    b.HasOne("BiiSoft.Authorization.Users.User", "Member")
                        .WithMany()
            ...
            modelBuilder.Entity("BiiSoft.ChartOfAccounts.ChartOfAccount", b =>
                {
                    ...
                    b.HasOne("BiiSoft.ChartOfAccounts.ChartOfAccount", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("BiiSoft.ContactInfo.ContactAddress", b =>
                {
                    ...
                    b.HasOne("BiiSoft.Locations.KhanDistrict", "KhanDistrict")
                        .WithMany()
                        .HasForeignKey("KhanDistrictId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BiiSoft.Locations.Location", "Location")
                        .WithMany()
                        .HasForeignKey("LocationId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BiiSoft.Locations.SangkatCommune", "SangkatCommune")
                        .WithMany()
                        .HasForeignKey("SangkatCommuneId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BiiSoft.Locations.Village", "Village")
                        .WithMany()
                    ...
                    b.Navigation("KhanDistrict");

                    b.Navigation("Location");

                    b.Navigation("SangkatCommune");
            ...
            modelBuilder.Entity("BiiSoft.Items.ItemZone", b =>
                {
                    ...
                    b.HasOne("BiiSoft.Warehouses.Zone", "Zone")
                        .WithMany()
            ...
            modelBuilder.Entity("BiiSoft.Warehouses.WarehouseBranch", b =>
                {
                    ...
                    b.HasOne("BiiSoft.Warehouses.Warehouse", "Warehouse")
