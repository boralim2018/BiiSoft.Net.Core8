...
{
    public abstract class BiiSoftWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BiiSoftWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BiiSoftWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BiiSoftDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BiiSoftDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BiiSoftDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BiiSoftDbContext, Task<T>> func)
        {
            T result;
